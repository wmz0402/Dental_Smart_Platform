<template>
  <div class="alarm-page">
    <div class="header-action">
      ...
      <el-button type="primary" @click="handleRefresh">刷新告警列表</el-button>
    </div>
    ...
    <div class="glass-card alarm-table-box">
      ...
      <div class="table-responsive-wrapper">
        <el-table :data="alarmList" border stripe size="small" style="width: 100%; min-width: 700px;">
          ...
          <el-table-column label="快捷操作" width="110" align="center">
            <template #default="{ row }">
              <el-button
...
const consumables = computed(() => deviceStore.consumables);
...
const handleRefresh = async () => {
  await deviceStore.fetchAlarms();
  ElMessage.success('告警与预测维保列表数据已同步更新');
};
...
const resolveAlarm = async (id: number) => {
  ...
  ElMessage.success(`告警 #${id} 已成功处置闭环，状态已持久化同步`);
};
...
:global(html.light-theme) .consumable-card {
